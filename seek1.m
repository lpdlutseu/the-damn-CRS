function [p_1_ini,p_2_ini,p_c_ini,theta_ini]=seek1(Pt,Pr,h1,h2,h3,g1,g2,NT,N_user)
...
obj=-min(theta*log2(1+(abs(h1*p_c)^2)/((abs(h1*p_1)^2)+(abs(h1*p_2)^2)+1))+(1-theta)*log2(1+Pr*abs(h3)^2),...
    theta*log2(1+(abs(h2*p_c)^2)/((abs(h2*p_1)^2)+(abs(h2*p_2)^2)+1)))+...
