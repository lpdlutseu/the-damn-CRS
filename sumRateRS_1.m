function SR_RS_1=sumRateRS_1(Pt,Pr,h1,h2,h3,g1,g2,NT,p_1_ini,p_2_ini,p_c_ini,theta_ini,ind_relay,tolerance,num_iter)
...
Objective=min(alpha_c_1,alpha_c_2)-alpha_c_e;  
...
%     constraints(19)=(rho_c_2_ini^2)*(((h2*p_1)'*(h2*p_1))+((h2*p_2)'*(h2*p_2))+1)-2*real(p_c_ini'*h2'*h2*p_c)*rho_c_2_ini+((h2*p_c_ini)'*(h2*p_c_ini))*rho_c_2;
    ...
    Constraints=[constraints(1:15)<=0,constraints(18:23)<=0];
...
SR_RS_1=value(Objective);
fprintf('RS : theta_1= %1.0f,rate_1= %1.3E,ratio_1=%1.3f \n',[theta_opt SR_RS_1 ratio_comm]);
end